...
namespace T4WinHost
{
	...
	//-------------------------------------------------------------------------
	[Serializable]
	public class CustomCmdLineHost : ITextTemplatingSessionHost, ITextTemplatingEngineHost
	{
		...
		public IList<string> StandardAssemblyReferences
		{
			get
			{
				return new string[]
                {
					...
					typeof(T4Common.CodeOutputType).Assembly.Location,
					
					typeof(System.Xml.ConformanceLevel).Assembly.Location,
					typeof(System.Xml.Linq.LoadOptions).Assembly.Location,
					typeof(System.Data.Linq.ChangeAction).Assembly.Location,
					string.Format("{0}\\EnvDTE.dll",Environment.CurrentDirectory),
					typeof(CallContext).Assembly.Location,
					typeof(TfsTeamProjectCollection).Assembly.Location,
					typeof(VersionControlServer).Assembly.Location,
					typeof(System.Net.ICredentials).Assembly.Location
                };
			}
		}
