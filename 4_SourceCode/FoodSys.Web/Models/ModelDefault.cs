...
using System.Linq;
using System.Web;
using XAGZFSys.Web.Base;
using XAGZFSys.Biz.BizAccess;
using XAGZFSys.Entity.EntitySearch;
using XAGZFSys.Entity;
using Project.Web.Base.Utility;

namespace XAGZFSys.Web.Models
{
    public class ModelDefaultIndex : Model
    {
    ...
    public class ModelDefaultCreate : Model
    {
